...
const Signup = () => {
  return (
    <div className='font-[Inter] mx-auto max-w-md'>
      <div className='h-[4rem] flex justify-center my-6'>
      ...
      <p className='flex justify-center mb-6 font-semibold text-[1.6rem]'>Regístrate gratis para eschuchar</p>

      <div className='grid gap-y-8 mb-6'>
        <div className='grid gap-y-2'>
          <label className='font-semibold text-[0.9rem]'>¿Cual es tu correo electrónico?</label>
          <input 
        ...
        <div className='grid gap-y-2'>
          <label className='font-semibold text-[0.9rem]'>Confirma tu correo electrónico</label>
          <input 
            className='appearance-none p-[14px] border border-gray-500 rounded-sm'
            type='text'
        ...
        <div className='grid gap-y-2'>
          <label className='font-semibold text-[0.9rem]'>Crea una contraseña</label>
          <input 
            className='appearance-none p-[14px] border border-gray-500 rounded-sm'
            type='password'
        ...
        <div className='grid gap-y-2'>
          <label className='font-semibold text-[0.9rem]'>¿Cómo quieres que te llamemos?</label>
          <input 
            className='appearance-none p-[14px] border border-gray-500 rounded-sm'
            type='text'
      ...
      <div className='grid gap-y-4 justify-center'>
        ...
        <p>¿Ya tienes una cuenta? <NavLink className='underline text-[#1ed760]' to='/login'>Iniciar sesión</NavLink>.</p>
      </div>
    </div>
  )
}
