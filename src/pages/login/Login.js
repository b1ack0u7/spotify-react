...
const Login = () => {
  return (
    <div className='font-[Inter]'>
      <header className='pt-[25px] pb-[10px] mb-[30px]'>
        ...
        <div className='mt-5 bg-gray-300 w-full h-[1px]'/>
      </header>

      <div className='flex justify-center'>
        <div className='flex-col'>
          <div className='grid gap-y-3'>
            <button className='flex bg-[#3b5998] justify-center items-center w-[450px] h-[48px] font-semibold rounded-full text-white hover:border hover:border-black'>
              <p className='flex w-[280px] justify-center'>
                <i className='fi fi-brands-facebook mr-4 pt-[2px]'/>
                CONTINUAR CON FACEBOOK
              </p>
            </button>

            <button className='flex bg-black justify-center items-center w-[450px] h-[48px] font-semibold rounded-full text-white hover:border hover:border-white'>
              <p className='flex w-[280px] justify-center'>
                <i className='fi fi-brands-apple mr-4 pt-[2px]'/>
                CONTINUAR CON APPLE
              </p>
            </button>
            ...
            <button className='flex bg-white justify-center items-center w-[450px] h-[48px] font-semibold rounded-full text-gray-600 border border-gray-500 hover:border-black'>
              <p className='flex w-[280px] justify-center'>
                <i className='fi fi-brands-google mr-4 pt-[2px]'/>
          ...
          <div className='flex items-center mb-4'>
            <div className='mt-5 bg-gray-300 w-full h-[2px]'/>
            <p className='pt-5 mx-6 font-bold'>O</p>
            <div className='mt-5 bg-gray-300 w-full h-[2px]'/>
          </div>

          <div className='grid gap-y-4 mb-8'>
            <div className='grid gap-y-2'>
              <label className='font-semibold text-[0.9rem]'>Correo electrónico o nombre de usuario</label>
              <input 
                className='appearance-none p-[14px] border border-gray-500 rounded-sm'
                type='text'
            ...
            <div className='grid gap-y-2'>
              <label className='font-semibold text-[0.9rem]'>Contraseña</label>
              <input 
                className='appearance-none p-[14px] border border-gray-500 rounded-sm'
                type='password'
          ...
          <div className='flex justify-center mb-8'>
            <button 
              className='text-black font-semibold bg-[#1ed760] py-[14px] px-[32px] rounded-full mx-auto'
            >
              Iniciar Sesión
            </button>
          </div>
          ...
          <div className='flex-col mt-8'>
            <p className='font-bold text-[18px] text-center mb-4'>¿No tienes cuenta?</p>
